...
if (!Theatres::checkById($query['theatres_id'])) {
	Core::answer([
		'status'  => false,
...
if (Theatres::checkDateShow('afisha_id = :afisha_id AND theatres_id = :theatres_id AND date_show = :date_show', [':afisha_id,i' => $query['afisha_id'], ':theatres_id,i' => $query['theatres_id'], ':date_show,s' => $query['date']])) {
	Core::answer([
		'status'  => false,
...
Theatres::insertDateShow([
	...
	'theatres_id,i' => $query['theatres_id'],
